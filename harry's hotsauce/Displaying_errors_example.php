<?php 
   ...
   echo('You will get the following error message displayed, because they are undefined.<br />');  
   ...
   echo('<br /><br />We now have defined the variable $abc with the value "test" and the constant abc with the value of "Constant Value Assigned". ');
   echo ('<br /><br />');
   echo('The value of the variable $abc is <b> '.$abc.'</b>.'); //Notice: $abc is now a defined variable 
   echo('<br />The value of the constant abc is <b> '.abc.' </b>.'); //Notice: abc is now a defined variable 
