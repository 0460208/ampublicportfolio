...
<p class="titles">Registration</p>
   ...
   <form action="" method="post">
      ...
      First Name:
      <input name="firstName" input type="text" placeholder="First Name:" size="40"/>
      </div>
      
      <div class="label-wrapper">
      Last Name:
      <input type="text" placeholder="Last Name:" name="lastName" size="40"/>
      </div>      
      ...
      <div class="label-wrapper">
      <p>Password:</p>
      <input type="text" placeholder="Password:" name="password" size="40"/>
      </div>     
      ...
      $query ="INSERT INTO `Accounts` (`Account_lastname`, `Account_firstname`, `Account_email_address`, `Account_address1`, `Account_city`, `Account_state_region`, `Account_postal_code`, `Account_status`, `Account_created_date`, `Account_created_by`, `Account_last_update_date`, `Account_last_update_by`, `Account_AT_id`)
      VALUES ('$lastName','$firstName','$emailAddress','$address','$city','$state','$zipCode', 'active', '$dateTime', 'Registration Form', '$dateTime', 'Registration Form', '1')";
      ...
      //Insert customer username and password into the login table 
      $query2 = "INSERT INTO `Login` (`Login_username`, `Login_password`, `Login_status`, `Login_created_date`, `Login_created_by`, `Login_account_id`, `Login_last_update_date`, `Login_last_update_by`) 
