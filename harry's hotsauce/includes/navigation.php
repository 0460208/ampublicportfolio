...
$mappedLevelNames = array(1 => 'first', 2 => 'second', 3 => 'third', 4 =>
'fourth', 5 => 'fifth', 6 => 'sixth', 7 => 'seventh', 8 => 'eigth', 9 =>
'ninth');
...
// If the current item has a subsClass, it is $defaultUlClass
// The depth should always be + 1 since we're going a level deeper
displayAllSiteLinks($item['subs'], (isset($item['subsClass']) ?
$item['subsClass'] : ''), $depth + 1);
}
echo '</li>';
}
echo '</ul>';
...
<nav>
<?php
displayAllSiteLinks($allNavItems);
?>
</nav>
