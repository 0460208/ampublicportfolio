...
echo '<br /><br />';
echo 'If the answer is a one, logging of errors is already on, otherwise a zero means logging errors are off. ';
echo '<br /><br />';
echo 'Default / current setting is: '.ini_get('log_errors');
echo '<br /><br />';
...
echo '<br /><br />';
echo 'You can change the setting by using ini_set(&#39; log_errrors &#39; , &#39; 0 &#39;) in your code, as shown in this example.';
echo '<br /><br />';
