...
//Select all from order headers, limit by one record in descending order
...
print '<br />';
print '<br />';
//select all of the order details
$query3 = "SELECT * FROM `Order_details`, `Products`, `Inventory` WHERE `Order_details_inventory_id` = `Inventory_id` AND `Inventory_product_id` = `Products_id` AND `Order_details_header_id` = $orderHeaderID";
...
print '<br />';
print '<br />';
print '<p style="font-weight:bold; font-size:18px;">Your order is currently being processed. We will email you with a tracking order once your order has shipped.</p>';

print '<br />';
print '<br />';

print '<form>
<input type="button" value="Print this page" onClick="window.print()" class=removeItem"> 
</form>'; 
?>
</div>
