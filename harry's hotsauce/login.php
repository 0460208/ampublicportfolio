...
<div id="register-wrapper">
    ...
    if(isset($_POST['submitLogin']))
    {
      ...
      {
        $query_run = 0;
        echo ('Error executing query line 47: ' . mysqli_errno($link)." - ".mysqli_error($link)."<BR>");
      }
      else {
        ...
        if($query_num_rows == 0)
        {
          ...
          {
            $query_run2 = 0;
            echo ('Error executing query line 61: ' . mysqli_errno($link)." - ".mysqli_error($link)."<BR>");
          }
          // run error
        ...
        {
          // if log in credientials match get login Id and make it to a variable ID
          ...
          {
            $query_run3 = 0;
            echo ('Error executing query3 line 84: ' . mysqli_errno($link)." - ".mysqli_error($link)."<BR>");
          }
          ...
          {
            $result4 = 0;
            echo ('Error executing query4 line 91: ' . mysqli_errno($link)." - ".mysqli_error($link)."<BR>");
          }
